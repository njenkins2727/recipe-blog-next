      ...
      <div className="card card-compact w-96 bg-secondary shadow-xl mx-6 mt-8">
        ...
        <div className="card-body text-light font-raleway">
          ...
          <p className='line-clamp-3'>{data.desc}</p>
           ...
           <button onClick={AddSave}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" className='size-8 mt-2'>
            {saved == true ? 
            ...
            <button onClick={ViewRecipe} className="btn bg-primary text-light">View Recipe</button>
            </div>
        </div>
      </div>
  )
