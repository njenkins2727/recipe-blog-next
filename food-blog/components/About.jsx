  ...
  return (
    <div className='bg-base-100'>
      <div className='flex flex-col mx-5 sm:mx-10 md:mx-20 lg:mx-32 xl:mx-72 my-7'>
        <h1 className='font-playfair font-semibold text-3xl mt-3 text-center sm:text-left'>
          Welcome to OneBusyWeek!
        </h1>
        <p className='font-inter mt-5 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl'>
